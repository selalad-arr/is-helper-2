...
const FinalReportCompiler = () => {
    ...
    const { projectTitle, isLoaded: isProjectLoaded, coreConcept, is1ProjectTitle, is2ProjectTitle, is3ProjectTitle, independentProjectTitle } = useProjectData();
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Auto-inject coreConcept into Chapter 1 if it exists and no manual input is present
            const ch1Key = '1_0'; // Chapter 1, Section 1 (ที่มาและความสำคัญ)
            if (coreConcept && !allInputs[ch1Key]) {
                allInputs[ch1Key] = coreConcept;
            }
