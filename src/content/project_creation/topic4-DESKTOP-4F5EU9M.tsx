...
const ProjectTopic4 = () => {
    const { projectTitle, setCoreConcept } = useProjectData();

    return (
        <div className="space-y-6">
            <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-4">ก้าวที่ 4: วิเคราะห์ปัญหาที่อยากแก้ (AI) 🔍</h3>
