...
const Activity2 = () => (
    <div className="space-y-4">
         <p><b>คำชี้แจง:</b> ให้นักเรียนตั้งประเด็นปัญหาหรือเรื่องที่สนใจตามประเด็นที่นักเรียนสนใจ ทั้งจากตนเอง โรงเรียน ชุมชน สถานการณ์ปัจจุบันและสังคมโลก คนละ 3 ประเด็น</p>
         <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
                <thead className="bg-slate-100 dark:bg-slate-700">
                    <tr>
                        <th className="p-2 border border-slate-300 dark:border-slate-600">ลำดับ</th>
                        <th className="p-2 border border-slate-300 dark:border-slate-600">ประเด็น (Topic)</th>
                        <th className="p-2 border border-slate-300 dark:border-slate-600">เหตุผลสำคัญ</th>
                    </tr>
                </thead>
                <tbody>
                     {[...Array(3)].map((_, i) => (
